        ...
        <form action="?id=<?= $value['id'] ?>" method="post">
          ...
          <div class="form-row">
            <div class="form-group col-md-4">
              ...
              <input type="text" value="<?= $value['last_name'] ?>" class="form-control" id="inputLastName" name="inputLastName" placeholder="Фамилия" required pattern="[А-Яа-я]{1,32}">
            </div>
            <div class="form-group col-md-4">
              <label for="inputName">Имя</label>
              <input type="text" value="<?= $value['name'] ?>" class="form-control" id="inputName" name="inputName" placeholder="Имя" required pattern="[А-Яа-я]{1,32}">
            </div>
            <div class="form-group col-md-4">
              <label for="inputSecondName">Отчество</label>
              <input type="text" value="<?= $value['second_name'] ?>" class="form-control" id="inputSecondName" name="inputSecondName" placeholder="Отчество" required pattern="[А-Яа-я]{1,32}">
            </div>
          </div>
          ...
          <div class="form-row">
            ...
            <div class="form-group col-md-4">
              ...
              <input type="text" value="<?= $value['phone_number'] ?>" class="form-control" id="inputPhoneNumber" name="inputPhoneNumber" placeholder="89876806524" required pattern="\8\[0-9]{3}\[0-9]{3}\[0-9]{2}\[0-9]{2}">
            </div>
          </div>
          ...
          <div class="form-row">
            ...
            <div class="form-group col-md-4">
              ...
              <input type="number" value="<?= $value['cost_percent'] ?>" min="0" max="100" class="form-control" id="inputCostPercent" name="inputCostPercent" onkeyup=enforceMinMax(this) required>
            </div>
          </div>
