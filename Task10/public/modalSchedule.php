  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content shadow">
      ...
      <div class="modal-body">
        <form action="?id=<?= $value['id'] ?>&master_id=<?= $_GET['master_id'] ?>" method="post">


          <div class="form-row">
            <div class="form-group">
              <label for="inputDate">Дата работы</label>
              <input type="date" value="<?= $value['work_date'] ?>" class="form-control" id="inputDate" name="inputDate" required>
            </div>
          </div>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content shadow">
      ...
      <div class="modal-footer">
        ...
        <form action="?id=<?= $value['id'] ?>&master_id=<?= $_GET['master_id'] ?>" method="post">
          <button type="submit" name="delete_submit_schedule" class="btn btn-danger">Удалить</button>
        </form>
      </div>
    </div>
  </div>
