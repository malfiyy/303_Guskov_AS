    ...
    <div class="row">
      <div class="col-12">
        ...
        <table class="table table-striped table-hover mt-4 text-center">
          ...
          <tbody>
            <?php foreach ($workschedule as $value) { ?>
              <tr>
                ...
                <td>
                  ...
                  <a href="?delete=<?= $value['id'] ?>$master_id=<?= $_GET['master_id'] ?>" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#deleteModalSchedule<?= $value['id'] ?>">
          ...
          <form action="" method='post'>
            ...
            <div class="form-row">
              <div class="form-group">
                ...
                <input type="time" class="form-control" id="inputStartTime" name="inputStartTime" onChange="change(this.value)" required>
              </div>
            </div>
